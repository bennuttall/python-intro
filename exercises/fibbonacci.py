...
'''
    ...
    Each number in the sequence is made of the sum of the previous two numbers
...
### 4. Write a function to give the number needed for the sequence to exceed n
'''
    i.e. fib_exceeds(1000000) => 31
'''
